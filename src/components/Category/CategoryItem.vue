<template>
    <a-card hoverable>
        <template #cover>
            <img alt="example" :src="data.image || 'https://gw.alipayobjects.com/zos/rmsportal/JiqGstEfoWAOHiTxclqi.png'"
...
const handleDelete = async (id) => {
    try {
        const res = await api.delete(admins.category, id);
